const Elevator = function (options) {
  ...
  function getVerticalOffset (element) {
    ...
    let el = element;
    while (el) {
      verticalOffset += el.offsetTop || 0;
      if (el.offsetParent && el.offsetParent.tagName == 'BODY' && targetElement) {
        el = null
      } else {
        el = el.offsetParent;
      }
  ...
  function animateLoop (time) {
    ...
    container.scrollTo(0, easedPosition);
  ...
  //     C__O__O__O__D
  //    [_____________]
  this.elevate = function (newTargetEL) {
    if (elevating) {
      return;
    }
    targetElement = newTargetEL;
    elevating = true;
  ...
  function onWindowBlur () {
    ...
    if (elevating) {
      ...
      updateEndPosition();
      container.scrollTo(0, endPosition);
    }
  }
  ...
  function bindElevateToElement (element) {
    if (element.addEventListener) {
      ...
      element.attachEvent("onclick", function () {
        ...
        container.scroll(0, endPosition);
      });
    }
  }
